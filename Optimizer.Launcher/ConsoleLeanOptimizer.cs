...
namespace QuantConnect.Optimizer.Launcher
{
    ...
    public class ConsoleLeanOptimizer: LeanOptimizer
    {
        ...
        /// </summary>
        protected override void TriggerOnEndEvent(EventArgs eventArgs)
        {
            var result = Strategy.Solution;
            Console.WriteLine($"Result {result.Profit} was reached using ParameterSet: ({result.ParameterSet})");

            base.TriggerOnEndEvent(eventArgs);
        }
